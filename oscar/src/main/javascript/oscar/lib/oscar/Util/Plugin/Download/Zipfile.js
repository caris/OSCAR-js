oscar.Util.Plugin.Download.Zipfile = new oscar.BaseClass(
...
oscar.getPluginManager().register(oscar.Util.Plugin.Download.Zipfile.prototype.pluginType,
	oscar.Util.Plugin.Download.Zipfile
);