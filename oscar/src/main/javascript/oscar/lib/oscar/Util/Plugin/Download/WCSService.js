...
oscar.Util.Plugin.Download.WCSService = new oscar.BaseClass(oscar.Util.Plugin.Download,{
	...
	play:function() {
		...
		this.ctrl = new oscar.Control.DataDiscovery(this.database,{closable:true,showAbstract:false,query:title});
		this.ctrl.events.on({
			"closed":function() {
