...
oscar.Util.Plugin.Download.WCSService = new oscar.BaseClass(oscar.Util.Plugin.Download.Options, {
    pluginType : "OGC:WCS-1.1.0-http-get-capabilities",
    icon : "ui-icon-wcs-download",
    cropControl : null,
    downloadOptions : {},
    initialize : function(options) {
        oscar.Util.Plugin.Download.Options.prototype.initialize.apply(this, [ options ]);
        this.events.on({
            "enterMode" : function() {
                try {
    ...
    showPreviewLayer : function() {
        ...
        if (isPreviewSupported(this.coverageDescription.supportedFormats)) {
            var GetCoverageOp = oscar.Util.Metadata.getOperation(this.capabilities, "GetCoverage");
            var previewLayer = new oscar.Layer.GetCoveragePreview(this.coverageDescription.identifier, oscar.PreviewCoverageProxy, {
...
oscar.getPluginManager().register(oscar.Util.Plugin.Download.WCSService.prototype.pluginType, oscar.Util.Plugin.Download.WCSService);