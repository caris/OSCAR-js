 ...
 * 
 */
oscar.Format.WFSCapabilities = oscar.BaseClass(OpenLayers.Format.WFSCapabilities, {
    /**
     * APIMethod: read
     * 
    ...
    read : function(data) {
        ...
        var constr = oscar.Format.WFSCapabilities["v" + version.replace(/\./g, "_")];
        if (!constr) {
    ...
    /**
     * Constant: CLASS_NAME - oscar.Format.WFSCapabilities
     */
