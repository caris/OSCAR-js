...
oscar.Format.WCSCapabilities = oscar.BaseClass(OpenLayers.Format.XML, {
	...
	/**
	 * Property: parser 
	 * {<OpenLayers.Format>} A cached versioned format used
	 * for reading.
	 */
	parser :null,
	...
	read : function(data) {
		...
		if (!this.parser || this.parser.version !== version) {
			var constr = oscar.Format.WCSCapabilities["v"
					+ version.replace(/\./g, "_")];
			if (!constr) {
				throw "Can't find a WCS capabilities parser for version "
						+ version;
			}
